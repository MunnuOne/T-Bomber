...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/Munnuon/ToxicBomber/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf MunnuOne && git clone https://github.com/Toxic-Noob/ToxicBomber > /dev/null 2>&1")
